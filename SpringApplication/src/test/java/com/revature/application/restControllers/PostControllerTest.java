...
public class PostControllerTest {
    ...
    public void returnAllPosts() throws Exception {
        ...
        mockMvc.perform(get("/posts")).andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$[0].postId", Matchers.is((int) posts.get(0).getPostId())))
                ...
                .andExpect(jsonPath("$[1].postId", Matchers.is((int) posts.get(1).getPostId())))
    ...
    public void returnSinglePost() throws Exception {
        ...
        mockMvc.perform(get("/posts/1")).andExpect(status().isOk())
                .andExpect(content().contentType(contentType))
                .andExpect(jsonPath("$.postId", Matchers.is((int) post1.getPostId())))
